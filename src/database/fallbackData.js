...
const sampleTopics = [
  {
    ...
    content: {
      ...
      explanation: 'ይህ ጽንሰ ሐሳብ ለሰው ልጅ ለመረዳት አስቸጋሪ ሊሆን ይችላል፣ ነገር ግን እግዚአብሔር የራሱን ስለራሱ ያሳየን ነው። በዮሐንስ 1:1 ላይ የሚለው "በመጀመሪያ ቃል ነበረ፣ ቃልም ከእግዚአብሔር ጋር ነበረ፣ ቃልም እግዚአብሔር ነበረ" ይህን ያሳያል። እንዲሁም በዮሐንስ 14:26 ላይ የመንፈስ ቅዱስ ስለ መምጣቱ ይነገራል።',
      keyPoints: [
  ...
  },
  {
    ...
    content: {
      ...
      explanation: 'መዳን ለማግኘት ሰው ልጅ በኢየሱስ ክርስቶስ ማመን አለበት። እንደ የሐዋርያት 4:12 ያለው "በሌላም ስም መዳን የለም፣ ምክንያቱም በሰማይ ሥር ለሰው ልጅ የተሰጠ ሌላ ስም የለም፣ በእርሱም ልንድን የምንችለው ነው"። እንዲሁም በሮሜ 10:9 ላይ "በአፍህ ጌታ ኢየሱስን ብትመሰክር በልብህም እግዚአብሔር እርሱን ከሙታን አስነስቶ እንደ ሆነ ብታምን ድን ያደርግሃል" ይለናል።',
      keyPoints: [
